...
poetry run python simulator.py --sequence sequences/locale-options.txt --sd
rm -f sd/settings.json
poetry run python simulator.py --sequence sequences/login-locale-de-de.txt --sd
rm -f sd/settings.json
...
poetry run python simulator.py --sequence sequences/print-qr.txt --printer
