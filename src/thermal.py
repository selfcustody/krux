...
class AdafruitThermalPrinter:
    """AdafruitThermalPrinter is a minimal wrapper around a serial connection to
    ...
    def initialize(self):
        """Initializes the connection to the printer and sets default settings"""
    ...
    def wake(self):
        """Wakes up the printer to get ready for printing"""
        self.timeout_set(0)
