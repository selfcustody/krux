...
def tdata(mocker):
    ...
    SINGLESIG_ACTION_KEY_SIGNET_P2WPKH = Key(
        ACTION_MNEMONIC, TYPE_SINGLESIG, NETWORKS["signet"], script_type=P2WPKH
    )
    SINGLESIG_ACTION_KEY_REGTEST_P2WPKH = Key(
        ACTION_MNEMONIC, TYPE_SINGLESIG, NETWORKS["regtest"], script_type=P2WPKH
    )
    LEGACY1_KEY = Key(
        TEST_12_WORD_MNEMONIC,
        TYPE_SINGLESIG,
    ...
    return namedtuple(
        ...
        [
            ...
            "SINGLESIG_ACTION_KEY_REGTEST_P2WPKH",
            "LEGACY1_KEY",
