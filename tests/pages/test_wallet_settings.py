...
def test_derivation_path_str_silent_payment(m5stickv, mocker):
    ...
    # A P2SH multisig wallet carries account=None; switching policy to SP must
    # fall back to account 0 instead of raising
    assert (
        wallet_settings._derivation_path_str(
            TYPE_SILENT_PAYMENT, P2TR, NETWORKS["main"], None
        )
        == "m/352h/0h/0h"
    )
