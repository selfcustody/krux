...
def test_sign_psbt(mocker):
    from krux.pages.home import Home
    from krux.wallet import Wallet

    cases = [
        # Single-key, not loaded, no format => pmofn, sign, No print prompt
        (SINGLEKEY_SIGNING_KEY, None, False, P2WPKH_PSBT_B64, FORMAT_NONE, True, SIGNED_P2WPKH_PSBT_B64, FORMAT_PMOFN, None, [BUTTON_ENTER, BUTTON_ENTER, BUTTON_ENTER]),
        # Single-key, not loaded, pmofn, sign, No print prompt
        (SINGLEKEY_SIGNING_KEY, None, False, P2WPKH_PSBT_B64, FORMAT_PMOFN, True, SIGNED_P2WPKH_PSBT_B64, FORMAT_PMOFN, None, [BUTTON_ENTER, BUTTON_ENTER, BUTTON_ENTER]),
        # Single-key, not loaded, pmofn, sign, Print
        (SINGLEKEY_SIGNING_KEY, None, False, P2WPKH_PSBT_B64, FORMAT_PMOFN, True, SIGNED_P2WPKH_PSBT_B64, FORMAT_PMOFN, MockPrinter(), [BUTTON_ENTER, BUTTON_ENTER, BUTTON_ENTER, BUTTON_ENTER]),
        # Single-key, not loaded, pmofn, sign, Decline to print
        (SINGLEKEY_SIGNING_KEY, None, False, P2WPKH_PSBT_B64, FORMAT_PMOFN, True, SIGNED_P2WPKH_PSBT_B64, FORMAT_PMOFN, MockPrinter(), [BUTTON_ENTER, BUTTON_ENTER, BUTTON_ENTER, BUTTON_PAGE]),
        # Single-key, not loaded, pmofn, decline to sign
        (SINGLEKEY_SIGNING_KEY, None, False, P2WPKH_PSBT_B64, FORMAT_PMOFN, False, None, None, None, [BUTTON_ENTER, BUTTON_PAGE]),
        # Single-key, not loaded, failed to capture PSBT QR
        (SINGLEKEY_SIGNING_KEY, None, False, None, None, False, None, None, None, [BUTTON_ENTER]),
        # Multisig, not loaded, decline to proceed after warning
        (MULTISIG_SIGNING_KEY, None, False, None, None, False, None, None, None, [BUTTON_PAGE]),
        # Multisig, not loaded, pmofn, sign, No print prompt
        (MULTISIG_SIGNING_KEY, None, False, P2WSH_PSBT_B64, FORMAT_PMOFN, True, SIGNED_P2WSH_PSBT_B64, FORMAT_PMOFN, None, [BUTTON_ENTER, BUTTON_ENTER, BUTTON_ENTER]),
        # Multisig, not loaded, pmofn, sign, Print
        (MULTISIG_SIGNING_KEY, None, False, P2WSH_PSBT_B64, FORMAT_PMOFN, True, SIGNED_P2WSH_PSBT_B64, FORMAT_PMOFN, MockPrinter(), [BUTTON_ENTER, BUTTON_ENTER, BUTTON_ENTER, BUTTON_ENTER]),
        # Multisig, not loaded, pmofn, sign, Decline to print
        (MULTISIG_SIGNING_KEY, None, False, P2WSH_PSBT_B64, FORMAT_PMOFN, True, SIGNED_P2WSH_PSBT_B64, FORMAT_PMOFN, MockPrinter(), [BUTTON_ENTER, BUTTON_ENTER, BUTTON_ENTER, BUTTON_PAGE]),
    ]
    for case in cases:
        wallet = Wallet(case[0])
        if case[2]:
