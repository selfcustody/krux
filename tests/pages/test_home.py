...
def test_wallet(mocker):
    ...
    for case in cases:
        ...
        ctx = mock.MagicMock(
            input=mock.MagicMock(wait_for_button=mock.MagicMock(side_effect=case[4])),
            wallet=wallet,
            printer=case[3],
        )
...
def test_scan_address(mocker):
    ...
    for case in cases:
        ...
        ctx = mock.MagicMock(
            input=mock.MagicMock(wait_for_button=mock.MagicMock(side_effect=case[6])),
            wallet=wallet,
            printer=case[4],
        )
...
def test_sign_psbt(mocker):
    ...
    for case in cases:
        ...
        ctx = mock.MagicMock(
            input=mock.MagicMock(wait_for_button=mock.MagicMock(side_effect=case[9])),
            wallet=wallet,
            printer=case[8],
        )
