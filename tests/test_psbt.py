...
def tdata(mocker):
    ...
    P2PKH_PSBT_UR_PSBT = UR("crypto-psbt", Types.psbt_to_cbor(P2PKH_PSBT))
    ...
    SIGNED_P2PKH_PSBT_UR_PSBT = UR("crypto-psbt", Types.psbt_to_cbor(SIGNED_P2PKH_PSBT))
    ...
    P2WPKH_PSBT_UR_PSBT = UR("crypto-psbt", Types.psbt_to_cbor(P2WPKH_PSBT))
    ...
    SIGNED_P2WPKH_PSBT_UR_PSBT = UR(
        "crypto-psbt", Types.psbt_to_cbor(SIGNED_P2WPKH_PSBT)
    )
    ...
    P2SH_P2WPKH_PSBT_UR_PSBT = UR("crypto-psbt", Types.psbt_to_cbor(P2SH_P2WPKH_PSBT))
    ...
    SIGNED_P2SH_P2WPKH_PSBT_UR_PSBT = UR(
        "crypto-psbt", Types.psbt_to_cbor(SIGNED_P2SH_P2WPKH_PSBT)
    )
    ...
    P2TR_PSBT_UR_PSBT = UR("crypto-psbt", Types.psbt_to_cbor(P2TR_PSBT))
    ...
    SIGNED_P2TR_PSBT_UR_PSBT = UR("crypto-psbt", Types.psbt_to_cbor(SIGNED_P2TR_PSBT))
    ...
    P2SH_PSBT_UR_PSBT = UR("crypto-psbt", Types.psbt_to_cbor(P2SH_PSBT))
    ...
    SIGNED_P2SH_PSBT_UR_PSBT = UR("crypto-psbt", Types.psbt_to_cbor(SIGNED_P2SH_PSBT))
    ...
    P2WSH_PSBT_UR_PSBT = UR("crypto-psbt", Types.psbt_to_cbor(P2WSH_PSBT))
    ...
    SIGNED_P2WSH_PSBT_UR_PSBT = UR("crypto-psbt", Types.psbt_to_cbor(SIGNED_P2WSH_PSBT))
    ...
    DESC_P2WSH_PSBT_UR_PSBT = UR("crypto-psbt", Types.psbt_to_cbor(DESC_P2WSH_PSBT))
    ...
    DESC_SIGNED_P2WSH_PSBT_UR_PSBT = UR(
        "crypto-psbt", Types.psbt_to_cbor(DESC_SIGNED_P2WSH_PSBT)
    )
    ...
    P2SH_P2WSH_PSBT_UR_PSBT = UR("crypto-psbt", Types.psbt_to_cbor(P2SH_P2WSH_PSBT))
    ...
    SIGNED_P2SH_P2WSH_PSBT_UR_PSBT = UR(
        "crypto-psbt", Types.psbt_to_cbor(SIGNED_P2SH_P2WSH_PSBT)
    )
    ...
    MINIS_P2WSH_PSBT_UR_PSBT = UR("crypto-psbt", Types.psbt_to_cbor(MINIS_P2WSH_PSBT))
    ...
    SIGNED_MINIS_P2WSH_PSBT_UR_PSBT = UR(
        "crypto-psbt", Types.psbt_to_cbor(SIGNED_MINIS_P2WSH_PSBT)
    )
    ...
    MINIS_TR_PSBT_UR_PSBT = UR("crypto-psbt", Types.psbt_to_cbor(MINIS_TR_PSBT))
    ...
    IN_KEY_SIGNED_MINIS_TR_PSBT_UR_PSBT = UR(
        "crypto-psbt", Types.psbt_to_cbor(IN_KEY_SIGNED_MINIS_TR_PSBT)
    )
    ...
    RECOV_M_TR_PSBT_UR_PSBT = UR("crypto-psbt", Types.psbt_to_cbor(RECOV_M_TR_PSBT))
    ...
    TAP_TREE_SIGNED_RECOV_PSBT_UR_PSBT = UR(
        "crypto-psbt", Types.psbt_to_cbor(TAP_TREE_SIGNED_RECOV_PSBT)
    )
    ...
    EXP_TR_MINIS_PSBT_UR_PSBT = UR("crypto-psbt", Types.psbt_to_cbor(EXP_TR_MINIS_PSBT))
    ...
    SIGNED_EXP_TR_MINIS_PSBT_UR_PSBT = UR(
        "crypto-psbt", Types.psbt_to_cbor(SIGNED_EXP_TR_MINIS_PSBT)
    )
