...
def tdata(mocker):
    ...
    P2WPKH_PSBT_UR_PSBT = base_encode(
        P2WPKH_PSBT, 64
    ).decode()  # UR("crypto-psbt", PSBT(P2WPKH_PSBT).to_cbor())
    ...
    SIGNED_P2WPKH_PSBT_UR_PSBT = base_encode(
        SIGNED_P2WPKH_PSBT, 64
    ).decode()  # UR("crypto-psbt", PSBT(SIGNED_P2WPKH_PSBT).to_cbor())
    ...
    P2SH_P2WPKH_PSBT_UR_PSBT = base_encode(
        P2SH_P2WPKH_PSBT, 64
    ).decode()  # UR("crypto-psbt", PSBT(P2SH_P2WPKH_PSBT).to_cbor())
    ...
    SIGNED_P2SH_P2WPKH_PSBT_UR_PSBT = base_encode(
        SIGNED_P2SH_P2WPKH_PSBT, 64
    ).decode()  # UR("crypto-psbt", PSBT(SIGNED_P2SH_P2WPKH_PSBT).to_cbor())
    ...
    P2WSH_PSBT_UR_PSBT = base_encode(
        P2WSH_PSBT, 64
    ).decode()  # UR("crypto-psbt", PSBT(P2WSH_PSBT).to_cbor())
    ...
    SIGNED_P2WSH_PSBT_UR_PSBT = base_encode(
        SIGNED_P2WSH_PSBT, 64
    ).decode()  # UR("crypto-psbt", PSBT(SIGNED_P2WSH_PSBT).to_cbor())
    ...
    P2SH_P2WSH_PSBT_UR_PSBT = base_encode(
        P2SH_P2WSH_PSBT, 64
    ).decode()  # UR("crypto-psbt", PSBT(P2SH_P2WSH_PSBT).to_cbor())
    ...
    SIGNED_P2SH_P2WSH_PSBT_UR_PSBT = base_encode(
        SIGNED_P2SH_P2WSH_PSBT, 64
    ).decode()  # UR("crypto-psbt", PSBT(SIGNED_P2SH_P2WSH_PSBT).to_cbor())
