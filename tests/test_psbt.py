...
SIGNED_P2SH_P2WPKH_PSBT_UR_PSBT = UR('crypto-psbt', PSBT(SIGNED_P2SH_P2WPKH_PSBT).to_cbor())
...
SIGNED_P2SH_P2WSH_PSBT_UR_PSBT = UR('crypto-psbt', PSBT(SIGNED_P2SH_P2WSH_PSBT).to_cbor())
...
def test_outputs_singlekey():
    ...
    wallet = Wallet(Key(TEST_MNEMONIC, False, NETWORKS['test']))
    cases = [
        (P2WPKH_PSBT, ['Sending:\n₿0.10,000,000\n\nTo:\ntb1que40al7rsw88ru9z0vr78vqwme4w3ctqj694kx', 'Fee:\n₿0.00,002,820']),
        (P2SH_P2WPKH_PSBT, ['Sending:\n₿0.10,000,000\n\nTo:\ntb1que40al7rsw88ru9z0vr78vqwme4w3ctqj694kx', 'Fee:\n₿0.00,003,300'])
    ]
...
def test_outputs_multisig():
    ...
    wallet = Wallet(Key(TEST_MNEMONIC, True, NETWORKS['test']))
    cases = [
        (P2WSH_PSBT, ['Sending:\n₿0.18,993,880\n\nTo:\ntb1q35pg2rdt3p0v27dmdh9st43q8vzl29cps6kt3yradnqmg55eahfqfgn83n', 'Fee:\n₿0.00,006,120']),
        (P2SH_P2WSH_PSBT, ['Sending:\n₿0.10,000,000\n\nTo:\ntb1que40al7rsw88ru9z0vr78vqwme4w3ctqj694kx', 'Fee:\n₿0.00,004,260'])
    ]
