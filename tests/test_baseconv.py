...
TEST_VECTORS = [
    ...
    (binascii.unhexlify('73696d706c792061206c6f6e6720737472696e67'), '2YT--DWX-2WS5L5VEX1E:6E7C8VJ:E', '2cFupjhnEsSn59qHXstmK2ffpLv2', 'c2ltcGx5IGEgbG9uZyBzdHJpbmc='),
    (binascii.unhexlify('00eb15231dfceb60925886b67d065299925915aeb172c06647'), '03+1P14XU-QM.WJNJV$OBH4XOF5+E9OUY4E-2', '1NS17iag9jJgTHD1VXjvLCEnZuQ3rJDE9L', 'AOsVIx3862CSWIa2fQZSmZJZFa6xcsBmRw=='),
    (binascii.unhexlify('516b6fcd0f'), '1CDVY/HG', 'ABnLTmg', 'UWtvzQ8='),
    (binascii.unhexlify('bf4f89001e670274dd'), '22DOOE00VVRUHY', '3SEo3LWLoPntC', 'v0+JAB5nAnTd'),
    (binascii.unhexlify('572e4794'), '9.ZLRA', '3EFU7m', 'Vy5HlA=='),
    (binascii.unhexlify('ecac89cad93923c02321'), 'F5JWS5AJ:FL5YV0', 'EJDM8drfXA6uyA', '7KyJytk5I8AjIQ=='),
    (binascii.unhexlify('10c8511e'), '1-FFWO', 'Rt5zm', 'EMhRHg=='),
    (binascii.unhexlify('00000000000000000000'), '0000000000', '1111111111', 'AAAAAAAAAAAAAA=='),
    (binascii.unhexlify('000111d38e5fc9071ffcd20b4a763cc9ae4f252bb4e48fd66a835e252ada93ff480d6dd43dc62a641155a5'), '05V$PS0ZWYH7M1RH-$2L71TF23XQ*HQKJXQ96L5E9PPMWXXHT3G1IP.HT-540H', '123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz', 'AAER045fyQcf/NILSnY8ya5PJSu05I/WaoNeJSrak/9IDW3UPcYqZBFVpQ=='),
    (binascii.unhexlify(''), '060PLMRVA3TFF18/LY/QMLZT76BH2EO*BDNG7S93KP5BBBLO2BW0YQXFWP8O$/XBSLCYPAIOZLD2O$:XX+XMI79BSZP-B7U8U*$/A3ML:P+RISP4I-NQ./-B4.DWOKMZKT4:5+M3GS/5L0GWXIW0ES5J-J$BX$FIWARF.L2S/J1V9SHLKBSUUOTZYLE7O8765J**C0U23SXMU$.-T9+0/8VMFU*+0KIF5:5W:/O:DPGOJ1DW2L-/LU4DEBBCRIFI*497XHHS0.-+P-2S98B/8MBY+NKI2UP-GVKWN2EJ4CWC3UX8K3AW:MR0RT07G7OTWJV$RG2DG41AGNIXWVYHUBHY8.+5/B35O*-Z1J3$H8DB5NMK6F2L5M/1', '', ''),
    (PSBT, PSBT_BASE43, PSBT_BASE58, PSBT_BASE64)
]

def test_base_decode():
    for data, data_base43, data_base58, data_base64 in TEST_VECTORS:
...
def test_base_decode_from_unsupported_base():
    with pytest.raises(ValueError):
        base_decode(b'', 21)
        
def test_base_decode_from_wrong_base():
    with pytest.raises(ValueError):
        base_decode('abc'.encode(), 43)
        
def test_base_encode_to_unsupported_base():
    with pytest.raises(ValueError):
        base_encode(b'', 21)