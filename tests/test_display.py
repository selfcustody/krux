...
def test_to_lines(mocker):
    ...
    cases = [
        ...
        (135, 10, 'Log Level\nNONE', ['Log Level', 'NONE']),
        (135, 10, 'New firmware detected.\n\nSHA256:\n1621f9c0e9ccb7995a29327066566adfd134e19109d7ce8e52aad7bd7dcce121\n\n\n\nInstall?', ['New firmware', 'detected.', '', 'SHA256:', '1621f9c0e9ccb799', '5a29327066566adf', 'd134e19109d7ce8e', '52aad7bd7dcce121', '', '', 'Install?']),
        ...
        (75, 10, 'Log Level\nNONE', ['Log', 'Level', 'NONE']),
        (75, 10, 'New firmware detected.\n\nSHA256:\n1621f9c0e9ccb7995a29327066566adfd134e19109d7ce8e52aad7bd7dcce121\n\n\n\nInstall?', ['New', 'firmwar', 'e', 'detecte', 'd.', '', 'SHA256:', '1621f9c', '0e9ccb7', '995a293', '2706656', '6adfd13', '4e19109', 'd7ce8e5', '2aad7bd', '7dcce12', '1', '', '', '', 'Install', '?']),
        ...
        (240, 10, 'Log Level\nNONE', ['Log Level', 'NONE']),
        (240, 10, 'New firmware detected.\n\nSHA256:\n1621f9c0e9ccb7995a29327066566adfd134e19109d7ce8e52aad7bd7dcce121\n\n\n\nInstall?', ['New firmware detected.', '', 'SHA256:', '1621f9c0e9ccb7995a29327066566ad', 'fd134e19109d7ce8e52aad7bd7dcce1', '21', '', '', '', 'Install?']),
    ]
    for case in cases:
        mocker.patch('krux.display.lcd', new=mock.MagicMock(
...
def test_draw_hcentered_text(mocker):
    ...
    krux.display.lcd.draw_string.assert_called_with(30, 10, 'Hello world', krux.display.lcd.WHITE, krux.display.lcd.BLACK)
...
def test_draw_centered_text(mocker):
    ...
    d.draw_hcentered_text.assert_called_with('Hello world', 113, krux.display.lcd.WHITE, 0)
