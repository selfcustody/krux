...
<img src="/krux/es/img/maixpy_m5stickv/load-mnemonic-camera-options-250.png" align="right" class="m5stickv">
<img src="/krux/es/img/maixpy_amigo/load-mnemonic-camera-options-300.png" align="right" class="amigo">
...
<img src="/krux/es/img/maixpy_m5stickv/load-mnemonic-manual-options-250.png" align="right" class="m5stickv">
<img src="/krux/es/img/maixpy_amigo/load-mnemonic-manual-options-300.png" align="right" class="amigo">
...
#### Palabras
<img src="/krux/es/img/maixpy_m5stickv/load-mnemonic-via-text-word-250.png" align="right" class="m5stickv">
<img src="/krux/es/img/maixpy_amigo/load-mnemonic-via-text-word-300.png" align="right" class="amigo">
...
#### Números de palabras
<img src="/krux/es/img/maixpy_m5stickv/load-mnemonic-via-numbers-word-250.png" align="right" class="m5stickv">
<img src="/krux/es/img/maixpy_amigo/load-mnemonic-via-numbers-word-300.png" align="right" class="amigo">
...
#### Tinyseed (Bits)
<img src="/krux/es/img/maixpy_m5stickv/load-mnemonic-via-tinyseed-filled-250.png" align="right" class="m5stickv">
<img src="/krux/es/img/maixpy_amigo/load-mnemonic-via-tinyseed-filled-300.png" align="right" class="amigo">
...
#### Stackbit 1248
<img src="/krux/es/img/maixpy_m5stickv/load-mnemonic-via-stackbit-filled-250.png" align="right" class="m5stickv">
<img src="/krux/es/img/maixpy_amigo/load-mnemonic-via-stackbit-filled-300.png" align="right" class="amigo">
...
<img src="/krux/es/img/maixpy_m5stickv/load-mnemonic-storage-options-250.png" align="right" class="m5stickv">
<img src="/krux/es/img/maixpy_amigo/load-mnemonic-storage-options-300.png" align="right" class="amigo">
...
## Confirmar la configuración de la cartera
### Confirmar palabras mnemotécnicas
<img src="/krux/es/img/maixpy_m5stickv/load-mnemonic-seq-mnemonic-250.png" align="right" class="m5stickv">
<img src="/krux/es/img/maixpy_amigo/load-mnemonic-seq-mnemonic-300.png" align="right" class="amigo">
...
<img src="/krux/es/img/maixpy_m5stickv/load-mnemonic-seq-double-mnemonic-250.png" align="right" class="m5stickv">
<img src="/krux/es/img/maixpy_amigo/load-mnemonic-seq-double-mnemonic-300.png" align="right" class="amigo">
...
<img src="/krux/es/img/maixpy_m5stickv/load-mnemonic-seq-mnemonic-edited-wrong-250.png" align="right" class="m5stickv">
<img src="/krux/es/img/maixpy_amigo/load-mnemonic-seq-mnemonic-edited-wrong-300.png" align="right" class="amigo">
...
### Confirmar atributos de la cartera
<img src="/krux/es/img/maixpy_m5stickv/load-mnemonic-seq-overview-250.png" align="right" class="m5stickv">
<img src="/krux/es/img/maixpy_amigo/load-mnemonic-seq-overview-300.png" align="right" class="amigo">

Tras confirmar tu mnemónico, se mostrará una pantalla con un **cuadro de información en la parte superior** mostrando los atributos de la cartera. Si son los esperados, simplemente pulsa `Cargar cartera`. Si necesitas cambiar algo puedes personalizar la cartera estableciendo una `Contraseña` o usando el boton `Personalizar`.
...
La huella digital (fingerprint) de la cartera maestra [BIP32](https://github.com/bitcoin/bips/blob/master/bip-0032.mediawiki) te ayuda a verificar que ingresaste correctamente el mnemónico y la contraseña (opcional), y que se está cargando la cartera esperada. El fingerprint es el mejor checksum que puedes tener, por lo que es muy recomendable anotarlo y guardarlo.

##### Red (Network)
* ` Mainnet `:
Verifica si estás cargando una cartera de `Testnet` o de `Mainnet`.

##### Tipo de póliza (Policy Type)
* Verifica el tipo de póliza de la cartera: `Single-sig`, `Multisig`, `Miniscript`, o `TR Miniscript` (Taproot).

##### Camino de derivación (Derivation Path)
* :material-arrow-right-bottom: ` m/84h/0h/0h `:
El camino de derivación es una secuencia de números, o "nodos", que definen el tipo de script, la red y el índice de cuenta de tu cartera.
    * **Tipo de script** `84h`: El primer número define el tipo de script. El valor por defecto es `84h`, que corresponde a una cartera SegWit Nativa. Otros valores incluyen:
        * `44h` para Legacy
    ...
    * **Adicional**: En carteras multisig, se agrega un cuarto nodo con el valor `2h` al camino de derivación.
...
##### Contraseña
* ` Sin contraseña `:
Informa si la cartera tiene una frase de contraseña. Añadir o cambiar la contraseña genera una cartera y una huella digital completamente diferentes.

### Personalizar cartera
Es posible cambiar cualquiera de los **atributos de la cartera** (también se podrán cambiar más adelante, después de cargarla). Para que cargue más rápido la próxima vez, se pueden configurar algunos atributos predeterminados de la cartera en [ajustes](../settings.md): `Red`, `Tipo de póliza` y `Tipo de script`.
...
Este botón abre una pantalla para cambiar la `Red`, `Tipo de Póliza`, `Tipo de Script`, y la  `Cuenta` de la cartera. Si el `Tipo de Póliza` es Miniscript, podrá introducir una ruta de derivación personalizada.

<div style="clear: both"></div>

Cuando todo esté correcto, pulsa `Cargar cartera` y accederás al menú principal...
